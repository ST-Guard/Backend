...
public class Jira {
    ...
    public String createIssue(String projectKey, String summary, String descricao, String issueType) throws Exception {
        ...
        Map<String, Object> payload = Map.of(
                "fields", Map.of(
                        ...
                        "summary", summary,
                        "description", adfDescription, // Agora passamos o objeto complexo
